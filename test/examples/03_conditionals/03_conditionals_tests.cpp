...
TEST_CASE("Verify AND truth table") {
...
TEST_CASE("Verify OR truth table") {
...
TEST_CASE("Verify is_vowel function") {
...
TEST_CASE("Verify menu with switch statementr") {
