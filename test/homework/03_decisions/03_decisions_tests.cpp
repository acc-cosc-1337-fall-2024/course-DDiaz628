...
TEST_CASE("Verify get_letter_grade_using_if") {
	REQUIRE(get_letter_grade_using_if(115) == 'n');
	...
	REQUIRE(get_letter_grade_using_if(-10) == 'n');
}

TEST_CASE("Verify get_letter_grade_using_switch") {
	REQUIRE(get_letter_grade_using_switch(115) == 'N');
	...
	REQUIRE(get_letter_grade_using_switch(-10) == 'N');
}